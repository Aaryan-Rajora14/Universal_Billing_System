...
class UniversalBilling {
    ...
    // ===========================
    bindEvents() {
        // Sidebar toggle (desktop: collapse/expand | mobile: slide overlay)
        ...
        const openSidebar = () => {
            if (isMobile()) {
                ...
                localStorage.setItem('ubs_sidebar', 'open');
            }
        };
        const closeSidebar = () => {
            if (isMobile()) {
                ...
                localStorage.setItem('ubs_sidebar', 'closed');
            }
        };
        ...
        if (!isMobile() && localStorage.getItem('ubs_sidebar') === 'closed') {
            sidebar.classList.add('collapsed');
        }
